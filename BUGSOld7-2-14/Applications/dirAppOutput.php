...
<!-- end left column -->
	...
	<!--p>&nbsp;</p-->
		<h2>Application processed</h2>
		<p class="topmain">Thank you! Your application has been submitted. You should receive a confirmation email shortly. It may have been sent to spam. If not, contact the webmaster at</p>
