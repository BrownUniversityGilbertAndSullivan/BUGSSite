...
*/
  ...
  $email1 = 'Nicholas_Leiserson@brown.edu';
  $email2 = 'Charles_Shrader@brown.edu';
  $listservOwnerEmail = 'Richard_G_Ellis@brown.edu';
...
"Hello $name, this email confirms that you have registered for the BUGS Sing-in 2008.

This is the information you used to register.  If any of the following is inaccurate, please email Nick at njml@brown.edu or Charlie at Charles_Shrader@brown.edu.
...
Thanks for registering -- see you April 26!
Sing-In information is here:
http://www.brown.edu/Students/BUGS/events/sing-in/sing-in08/index.htm
...
http://www.brown.edu/Students/BUGS/";
  			...
  			if (!empty($city)){			
					...
					if (!empty($state)){
						...
						if(!empty($voice)){
							...
							if(!empty($roles)){
								mail( $senderemail, "Sing-in08 registration", $message, "From: $email1" );
  								mail( $email1, "Sing-in08 registration", $message, "From: $senderemail" );
  ...
  header( "Location: http://www.brown.edu/Students/BUGS/events/sing-in/sing-in08/register/thanks.htm");
  exit;
?>