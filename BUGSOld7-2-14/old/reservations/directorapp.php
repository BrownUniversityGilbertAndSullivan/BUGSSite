...
*/
  ...
  $email = 'evangeline_kurtz-nelson@brown.edu';
					...
					if (!empty($phone)){
						...
						if (!empty($senderemail)){
							...
							if(!empty($show)){
										...
										if (!empty($q3)){
											...
											if (!empty($q4)){
												...
												if (!empty($q5)){
													...
													header( "Location: http://www.brown.edu/Students/BUGS/reservations/dirAppOutput.htm" );
								...
								echo '<script language="javascript">
								history.back(); 
								alert("Please enter the name of the show you are proposing.")
								</script>;';
							}
						}
